defmodule OnlineShop.Accounts do
  @moduledoc """
  ...
  alias OnlineShop.Accounts.{User, UserToken, UserNotifier}
  ...
  def register_user(attrs) do
    ...
    |> User.mobile_number_changeset(attrs)
    |> User.bank_account_number_changeset(attrs)
    |> Repo.insert()
  end
  ...
  See `OnlineShop.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `OnlineShop.Accounts.User.password_changeset/3` for a list of supported options.

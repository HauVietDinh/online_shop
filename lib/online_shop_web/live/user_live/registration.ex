defmodule OnlineShopWeb.UserLive.Registration do
  use OnlineShopWeb, :live_view

  alias OnlineShop.Accounts
  alias OnlineShop.Accounts.User
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-sm">
        ...
        <.form for={@form} id="registration_form" phx-submit="save" phx-change="validate">
          ...
          />
          <.input
            field={@form[:bank_account_number]}
            type="text"
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: OnlineShopWeb.UserAuth.signed_in_path(socket))}
  end

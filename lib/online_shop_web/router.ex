defmodule OnlineShopWeb.Router do
  ...
  import OnlineShopWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {OnlineShopWeb.Layouts, :root}
  ...
  if Application.compile_env(:online_shop, :dev_routes) do
  ...
  scope "/", OnlineShopWeb do
    ...
    live_session :current_user,
      on_mount: [{OnlineShopWeb.UserAuth, :mount_current_scope}] do
